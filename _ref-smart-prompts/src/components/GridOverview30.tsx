...
export function GridOverview30({ currentIndex, onSelect, onClose }: Props) {
  return (
      ...
      <div className="sticky top-0 z-10 bg-background/95 backdrop-blur border-b border-border px-8 py-4 flex items-center justify-between">
        <div>
          <div className="font-mono text-xs text-ember uppercase tracking-[0.3em]">
            grilla · {slides30.length} slides
          </div>
          <div className="font-display text-xl font-bold mt-1">IA bien usada · 30 min</div>
        </div>
        <button
          onClick={onClose}
